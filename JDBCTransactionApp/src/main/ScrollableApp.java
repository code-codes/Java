...
public class ScrollableApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (connection != null)
                // Expecting ResultSet to be SCROLLABLE AND UPDATABLE - sql lite doesnt support this
            ...
            if (resultSet != null) {
                ...
                resultSet.absolute(-5);// from the ALR(after last record0 move the cursor in backward direction
                System.out.println(resultSet.getInt(1) + "\t" + resultSet.getString(2) + "\t" + resultSet.getInt(3)
                        + "\t" + resultSet.getString(4));
